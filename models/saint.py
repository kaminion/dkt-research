...
from models.utils import cal_acc_class, early_stopping, log_auc, save_auc, common_train, common_train_csedm, common_append, mean_eval, common_test, common_test_csedm, val_append, mean_eval_ext
...
def train_model(model, train_loader, valid_loader, num_q, num_epochs, opt, ckpt_path, mode=0, use_wandb=False):
    ...
    for epoch in range(0, num_epochs):
        ...
        for data in train_loader:
            ...
            if mode == 1: # CSEDM
                y, t, loss = common_train_csedm(model, opt, q, r, q2diff_seqs, m)
            else:
        ...
        with torch.no_grad():
            ...
            for data in valid_loader:
                ...
                if mode == 1: # CSEDM
                    q, y, t, loss = common_test_csedm(model, q, r, q2diff_seqs, m)
                else:
