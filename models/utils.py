...
def collate_ednet(batch, pad_val=-1):
    ...
    for answer_text in t_seqs:
        ...
        encoded_bert_sent = bert_tokenizer.encode_plus(
            text, add_special_tokens=True, truncation=True, return_token_type_ids=True
        )
...
def collate_fn(batch, pad_val=-1):
    ...
    for answer_text in at_seqs:
        ...
        # print(f"============= text: {text} ================")
        encoded_bert_sent = bert_tokenizer.encode_plus(
            text, add_special_tokens=False, padding='max_length', truncation=True, return_token_type_ids=True
        )
        bert_details.append(encoded_bert_sent)
