...
PRETRAIN_DIR = f"./ckpts/tokenizer/ASSIST2009/DISTIL_A2009"
...
def dkvmn_train_csedm(model, opt, q, r, label, m):
    inpt_q = q.long() 
    inpt_r = r.long()
...
def common_train_csedm(model, opt, q, r, label, m):
    inpt_q = q.long() 
    inpt_r = r.long()
...
def common_test_csedm(model, q, r, label, m):
    inpt_q = q.long()
    inpt_r = r.long()
...
def dkvmn_test_csedm(model, q, r, label, m):
    inpt_q = q.long() 
    inpt_r = r.long()
